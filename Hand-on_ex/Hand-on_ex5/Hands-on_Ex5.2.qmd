...
# Hands-on Exercise 5.2 - Visual Correlation Analysis
...
## 1.2 Importing and Preparing the Dataset
...
## 2.3 Including the correlation coefficients
...
I adjusted the font size as it was overlapping by including tl.cex=3
:::
...
grouped_ggcorrmat(
  ...
  ggcorrplot.args = list(
    outline.color = "black", 
    hc.order = TRUE,
    tl.cex = 3  # ↓ smaller text labels on axes
  ),
...
### 4.5.2 Reordering a correlation matrix using hclust
